...
git branch -M main
git remote add origin git@github.com:building-acoustics/building-acoustics-interface
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/building-acoustics/repositories/new](https://github.com/organizations/building-acoustics/repositories/new)
and create a new repository named `building-acoustics-interface` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/building-acoustics/building-acoustics-interface/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
